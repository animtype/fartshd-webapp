...
p.callout { display: inline-block; width: 100%; }
a.callout{position:absolute;z-index:11;left:calc(50% - 120px);-webkit-border-radius:50%;-moz-border-radius:50%;-ms-border-radius:50%;border-radius:50%;width:220px;height:220px;display:block;background:#daa520;line-height:34px;text-align:center;vertical-align:center;font-size:32px;font-weight:800;margin:0;color:#fff;text-decoration:none;cursor:pointer}a.callout:hover{background-color:#4743d8}a.callout::after,a.callout::before{content:" ";position:absolute;margin:auto;top:0;left:0;bottom:0;right:0;width:100%;height:100%;display:block;border-radius:500px;-webkit-animation:zoom 2s infinite;-moz-animation:zoom 2s infinite;-ms-animation:zoom 2s infinite;-o-animation:zoom 2s infinite;animation:zoom 2s infinite;-webkit-transform:scale(0);-moz-transform:scale(0);-ms-transform:scale(0);-o-transform:scale(0);transform:scale(0);background:rgba(83,70,0,0.4)}a.callout::before{-webkit-animation-delay:.3s;-moz-animation-delay:.3s;-ms-animation-delay:.3s;-o-animation-delay:.3s;animation-delay:.3s}@-webkit-keyframes zoom{from{-webkit-transform:scale(0);opacity:1}70%{-webkit-transform:scale(1)}100%{-webkit-transform:scale(1);opacity:0}}@-moz-keyframes zoom{from{-moz-transform:scale(0);opacity:1}70%{-moz-transform:scale(1)}100%{-moz-transform:scale(1);opacity:0}}@-o-keyframes zoom{from{-o-transform:scale(0);opacity:1}70%{-o-transform:scale(1)}100%{-o-transform:scale(1);opacity:0}}@keyframes zoom{from{transform:scale(0);opacity:1}70%{transform:scale(1)}100%{transform:scale(1);opacity:0}}a.callout small{ font-size:16px;font-weight:400;color:black; }
	
	amp-social-share {background-size: 80%; border-radius: 4px; }
...
<header>
	<section class="innerSmall">
		...
		<p class="callout transition"><a href="<?php echo $app_farts; ?>" class="callout shadow"><br><br>Start<br>farting!<br><small>click here</small></a></p>
	</section>
...
<main>
	<section class="inner top32">
		...
		<p class="innerCenter top32 transition">
            ...
            <a href="<?php echo $app_farts; ?>#tablet" class="tile transition">				
				<amp-img src="img/tile-tablet.jpg" width="220" height="150" layout="fixed" alt="smartphone"></amp-img>
				<span class="grey">Let’s play it on</span>
				<span class="grey top16 big">Tablet</span>
				<span class="grey top32">Supported all screen sizes and models. Enjoy!</span>
				<small class="badge new">v2.1</small>
			</a>
			<a href="<?php echo $app_farts; ?>#pc" class="tile transition">				
				<amp-img src="img/tile-desktop.jpg" width="220" height="150" layout="fixed" alt="smartphone"></amp-img>
				<span class="grey">Let’s play it on</span>
				<span class="grey top16 big">PC</span>
				<span class="grey top32">Play it on PC, Surface pro, Chromebook and Linux.</span>
				<small class="badge new">v2.1</small>
			</a>
	...
	<section class="inner padding top48">
		...
		<?php /*
        <p class="top32 center">
			<a href="<?php echo $app_farts; ?>" class="lead3"><span class="arrow arrowImage transition"></span><span class="forArrow">Start farting!</span></a>
		</p>
        */ ?>
        <p class="callout transition"><a href="<?php echo $app_farts; ?>" class="callout shadow"><br><br>Start<br>farting!<br><small>click here</small></a></p>
        <p class="top32">&nbsp;</p>
