...
<div class="share-container clearfix">
    <ul class="rrssb-buttons clearfix">
        ...
        <li class="googleplus">
            <a href="https://plus.google.com/share?url=<?php echo $encoded_msg ?><?php echo $encoded_url ?>" class="popup">
                <span class="icon">
                    <svg version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" width="28px" height="28px" viewBox="0 0 28 28" enable-background="new 0 0 28 28" xml:space="preserve">
                        <g>
                            <g>
		...
		<li class="linkedin">
            <a href="http://www.linkedin.com/shareArticle?mini=true&amp;url=<?php echo $encoded_url ?>&amp;title=<?php echo $encoded_sub ?>&amp;summary=<?php echo $encoded_msg ?>" class="popup">
                <span class="icon">
                    <svg version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" width="28px" height="28px" viewBox="0 0 28 28" enable-background="new 0 0 28 28" xml:space="preserve">
